<t-form controller="project" action="process" domain="project">
    <div class ="container-fluid">
        ...
        <input type="hidden" name="DataCompletamento" id="DataCompletamento" value="@{project->DataCompletamento:[]}">
        ...
        <input type="text" class="form-control" required id="Nome" name="Nome" value="@{project->Nome:[]}" placeholder="${return L::project_formname}">

        <label class="pt-2" for="Descrizione"><?php echo L::project_formdescription ?>:</label>
        <textarea class="form-control" required id="Descrizione" name="Descrizione" placeholder="${return L::project_formdescription}"><?php if(isset($this->project->Descrizione)) echo $this->project->Descrizione; else ""; ?></textarea>
        ...
        <div class="cust-dropdown">
            ...
            <input type="text" class="form-control" placeholder="${return L::project_addgroup}" 
